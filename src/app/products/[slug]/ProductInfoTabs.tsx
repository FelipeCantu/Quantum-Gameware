  ...
  return (
    <>
      <div className="bg-white/10 backdrop-blur-lg rounded-xl md:rounded-2xl border border-white/20 overflow-hidden">
        {/* Enhanced Tab Navigation with Drag to Scroll */}
        <div className="border-b border-white/20">
          {/* Horizontal Scroll with Drag Functionality */}
          <div 
            ref={scrollContainerRef}
            className={`flex overflow-x-auto modern-tab-scrollbar select-none ${
      ...
      {/* Global CSS for Smooth Scrolling - No Scrollbar */}
      <style jsx global>{`
        /* Hide scrollbar on all devices */
        .modern-tab-scrollbar {
          scrollbar-width: none; /* Firefox */
          -ms-overflow-style: none; /* IE and Edge */
        }

        .modern-tab-scrollbar::-webkit-scrollbar {
