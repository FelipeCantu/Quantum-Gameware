                ...
                {items.map((item, index) => (
                  ...
                  >
                    <div className="flex flex-col lg:flex-row gap-6">
                      {/* Product Image */}
                      <div className="relative h-32 w-32 flex-shrink-0 overflow-hidden rounded-2xl mx-auto lg:mx-0 bg-gray-100">
                        <Image
                          src={item.image}
                          alt={item.name}
                          fill
                      ...
                      <div className="flex-1 space-y-4">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                          ...
                          <button 
                            ...
                            className="flex items-center justify-center text-red-600 hover:text-red-700 font-medium transition-colors bg-red-50 hover:bg-red-100 px-4 py-2 rounded-xl"
                          >
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 sticky top-32">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Link
                    href="/products"
                    className="w-full bg-white hover:bg-gray-50 text-gray-900 px-8 py-3 rounded-2xl font-medium border border-gray-200 hover:border-gray-300 transition-all duration-300 text-center block"
                  >
                    Continue Shopping
                  </Link>
                </div>
                ...
                <div className="pt-6 border-t border-gray-200">
                  <details className="group">
                    <summary className="flex items-center justify-between cursor-pointer text-gray-700 hover:text-gray-900 transition-colors">
                ...
                <div className="space-y-4">
                  <div className="flex gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-gray-900 truncate">Gaming Mouse Pad</h4>
                      <p className="text-sm text-gray-600">Extended RGB mousepad</p>
