...
export default function Header() {
  ...
  return (
    <header className={`
      ...
      ${isScrolled 
        ? 'bg-white/95 backdrop-blur-xl shadow-lg shadow-gray-900/5 py-2 border-b border-gray-200/50' 
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center min-w-0 flex-shrink-0">
            <Link href="/" className="group flex items-center space-x-3 transition-transform hover:scale-105">
              <div className={`relative w-12 h-12 flex-shrink-0 overflow-hidden rounded-xl p-1.5 shadow-lg group-hover:shadow-xl transition-all duration-300 ${
                isScrolled 
          ...
          {/* Action Buttons - Fixed width for consistency */}
          <div className="flex items-center justify-end space-x-2 min-w-0 flex-shrink-0">
            {/* Cart Button */}
            <button 
              onClick={toggleCart}
              className={`
                relative p-3 group rounded-xl transition-all duration-300
            ...
            >
              ...
              {cartCount > 0 && (
                <span className={`
                  ...
                  transform transition-all duration-300 animate-pulse hover:animate-none shadow-lg
                  ${isScrolled 
            ...
            >
              <div className="relative w-6 h-6">
                <span className={`
                  absolute h-0.5 w-6 transform transition-all duration-300 ease-in-out
