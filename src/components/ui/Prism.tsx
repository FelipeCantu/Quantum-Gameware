...
const Prism = ({
  ...
  // Ensure we're on the client before rendering WebGL
  useEffect(() => {
    setIsClient(true);
  }, []);
  ...
  useEffect(() => {
    ...
    // Use lower DPR for faster initial render
    ...
    // Start rendering immediately - no delays
    ...
    // Always start immediately for instant visual feedback
    // Use setTimeout with 0 to ensure it runs on next tick after DOM is ready
